...
<body class="bg-light d-flex align-items-center" style="height: 100vh;">
    <div class="container d-flex justify-content-center">
        ...
        <form action="" method="POST">
            ...
            <button type="submit" name="login" class="btn btn-dark w-100 mb-2"> Login </button>
             <div class="text-center small">Belum punya akun? <a href="register.php">Daftar disini</a></div>
        </form>
        </div>
    </div>
